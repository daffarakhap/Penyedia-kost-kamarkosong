  ...
  <header id="header" style="height: 115px">
    <div class="container">
      ...
      <nav id="nav-menu-container">
        <ul class="nav-menu" >
          <li class=""><a href="beranda.html" style="font-size: 16px ">Beranda</a></li>
          ...
          <form action="" method="post" role="form" class="contactForm">
            <div class="form-row">
              <div class="form-group col-md-10" style="padding-left: 185px">
                <input style="text-align: center; height: 50px; font-size: 20px"  type="text" name="name" class="form-control" id="name" value="Bumi Marina Emas" data-rule="minlen:1" data-msg="Please enter the address" list="wilayah" />
                  <datalist id="wilayah">
            ...
            <!-- <a href="#" class="btn-projects scrollto">Get Started</a> -->
              ...
              <a href="hasilpencarian.html" class="btn-get-started scrollto">Cari</a>
            </div>
                  ...
                  <div class="row-md-12">
                      <div class="col-md-12  padding-0 box-v4-alert">
                        ...
                        <select style="font-size: 16px; width: 230px; text-align: center;" >
                          ...
                          <option value="opel" selected="">Perempuan</option>
                        </select>
                        </p>
                        ...
                        <select style="font-size: 16px; width: 230px; text-align: center;" >
                          ...
                          <option value="saab" selected="">Bulanan</option>
                        ...
                        <select style="font-size: 16px; width: 230px; text-align: center;" >
                          ...
                          <option value="volvo" selected="">Rp 500.000 - Rp 1000.000</option>
                        ...
                        <div style="font-size: 16px; width: 230px;" >
                          ...
                          <input type="checkbox" name="vehicle" value="Car" checked=""> Listrik<br>
                          <input type="checkbox" name="vehicle" value="Car"> Keamanan 24 Jam<br>
                          <input type="checkbox" name="vehicle" value="Car"> Kebersihan<br>
                          <input type="checkbox" name="vehicle" value="Car" checked=""> Kamar Mandi Dalam<br>
                          <input type="checkbox" name="vehicle" value="Car"> Kamar Mandi Luar<br>
                          <input type="checkbox" name="vehicle" value="Car" checked=""> PDAM<br>
                          <input type="checkbox" name="vehicle" value="Car"> Penjaga Kos 24 Jam<br>
                          <input type="checkbox" name="vehicle" value="Bike" checked=""> WiFi<br>
                        </div>
                        </p>
                       
                        <hr>
                        <div style="text-align: right;">
                          <a href="hasilpencarian.html"><button class="btn-get-started" type="submit" style="font-size: 16px; background-color: #e2e2e2; color: #000000"><b>Cari</b></button></a>
                        </div>
